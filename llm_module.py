...
AVAILABLE_LLM_MODELS = {
    ...
    'gpt-5.5': LLMModel(AIProvider.OPENAI, 'gpt-5.5'),
    'o3': LLMModel(AIProvider.OPENAI, 'o3'),
    'claude-haiku-4-5': LLMModel(AIProvider.ANTHROPIC, 'claude-haiku-4-5'),
    'claude-sonnet-5': LLMModel(AIProvider.ANTHROPIC, 'claude-sonnet-5'),
    'claude-opus-4-8': LLMModel(AIProvider.ANTHROPIC, 'claude-opus-4-8'),
    'gpt-oss:20b': LLMModel(AIProvider.OLLAMA, 'gpt-oss-20-128k', vision=False),
    'gemma4:26b': LLMModel(AIProvider.OLLAMA, 'gemma4:26b'),
    'qwen3.6:35b': LLMModel(AIProvider.OLLAMA, 'qwen3.6:35b'),
    ...
    'anthropic/claude-sonnet-5': LLMModel(AIProvider.OPENROUTER, 'anthropic/claude-sonnet-5', 'or/claude-sonnet-5'),
    'anthropic/claude-opus-4.8': LLMModel(AIProvider.OPENROUTER, 'anthropic/claude-opus-4.8', 'or/claude-opus-4.8'),
    'openai/gpt-5.5': LLMModel(AIProvider.OPENROUTER, 'openai/gpt-5.5', 'or/gpt-5.5'),
    ...
    'google/gemini-3.1-pro-preview': LLMModel(AIProvider.OPENROUTER, 'google/gemini-3.1-pro-preview', 'or/gemini-3.1-pro-preview'),
    'google/gemini-3-flash-preview': LLMModel(AIProvider.OPENROUTER, 'google/gemini-3-flash-preview', 'or/gemini-3-flash-preview'),
    '~x-ai/grok-latest': LLMModel(AIProvider.OPENROUTER, '~x-ai/grok-latest', 'or/grok'),
