...
AVAILABLE_LLM_MODELS = {
    ...
    'anthropic/claude-sonnet-4.6': LLMModel(AIProvider.OPENROUTER, 'anthropic/claude-sonnet-4.6', 'or/claude-sonnet-4.6'),
    'anthropic/claude-opus-4.6': LLMModel(AIProvider.OPENROUTER, 'anthropic/claude-opus-4.6', 'or/claude-opus-4.6'),
    'openai/gpt-5.4': LLMModel(AIProvider.OPENROUTER, 'openai/gpt-5.2', 'or/gpt-5.2'),
